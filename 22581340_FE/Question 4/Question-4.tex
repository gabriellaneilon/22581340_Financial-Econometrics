...
\begin{abstract}
\small{
For this analysis, I examined the top three and bottom three performing
indexes based on their rolling returns. Subsequently, I investigated
periods marked by the highest inflows and outflows observed in these
funds.
}
\end{abstract}
...
The aim of this report is to examine the top and bottom three actively
managed funds and explore the correlation between their performance and
investment flows managed by fund managers.
